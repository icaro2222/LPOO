...
<body>
	...
	<main class="bananaMain">
		...
		<form action="ConsultarAluno" method="post" class="consultarcurso">
			<h2>Consulta Aluno</h2><br>
			<div class="buscarnome">
				<label><strong>CPF :</strong></label><input type="text"
					name="cpf" spacehoder="cpf" min="11" maxlength="11">
			</div>
			<div>
    ...
    <div class="modal-alterar">
		<form action="AlterarAluno" method="post" class="matAlunoForm">
			...
			<div>
				...
				<input type="text" name="cpf" placeholder="Cpf" value="<%out.print(aluno.getCpf()); %>" required></input>
			</div>
			<div>
